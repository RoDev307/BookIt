    ...
    <nav class="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <button
                    class="flex items-center space-x-2 text-sm font-semibold text-slate-700 hover:text-slate-900 transition-colors bg-slate-100 px-3 py-1.5 rounded-xl">
                    <div
                        class="w-6 h-6 rounded-full bg-indigo-600 flex items-center justify-center text-white text-xs font-bold">
                        O
                    </div>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-6">
                        ...
                        <p class="mt-2 text-slate-600 text-sm leading-relaxed">Estilo, cortes modernos y cuidado de
                            barba con barberos profesionales altamente capacitados.</p>
                    </div>
                </div>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-6">
                        ...
                        <p class="mt-2 text-slate-600 text-sm leading-relaxed">Consultas generales y especializadas
                            enfocadas en el cuidado prioritario y preventivo de tu salud.</p>
                    </div>
                </div>
                <div class="p-6 bg-slate-50 border-t border-slate-100">
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-6">
                        ...
                        <p class="mt-2 text-slate-600 text-sm leading-relaxed">Mantenimiento preventivo, diagnóstico
                            computarizado y soluciones de mecánica general de alta precisión.</p>
                    </div>
                </div>
                <div class="p-6 bg-slate-50 border-t border-slate-100">
