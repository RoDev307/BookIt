    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight sm:text-5xl mt-4">
                Comercios Aliados de Nuestra <span class="text-indigo-600">Red</span>
            </h1>
        ...
        <!-- Grilla de Casos de Éxito Estáticos -->
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">

            @forelse($businesses as $business)
                <div
                    class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col justify-between group">
                    <div>
                    ...
                    <!-- Pie de tarjeta meramente informativo (Sin botones interactivos) -->
                    <div
                        class="p-6 bg-slate-50 border-t border-slate-100 flex justify-between items-center text-xs text-slate-400 font-medium">
                        <span>Licencia de Instancia:</span>
                        <span
                            class="text-indigo-600 font-bold bg-indigo-50 border border-indigo-100 px-2 py-0.5 rounded-md">Enterprise</span>
                    </div>
                </div>
            @empty
