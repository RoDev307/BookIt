...
<body class="bg-slate-50 font-sans antialiased">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div id="panel-reserva" class="hidden">
                <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-6 sticky top-24">
        ...
        <p class="text-center text-xs text-slate-400 mt-12">BookIt Empresarial © 2026. Todos los derechos reservados.</p>
    </div>
